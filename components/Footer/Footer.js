...
function Footer() {
  return (
    <Box rootType="footer" style={{ flexFlow: 'row nowrap', justifyContent: 'space-around', alignItems: 'center' }}>
      ...
      <Box style={{ flexFlow: 'row nowrap' }} >
        <a href="https://github.com/kriasoft/react-static-boilerplate" role="button" title="GitHub">
          <svg width="36" height="36" viewBox="0 0 24 24">
            <path
              fill="#000" d="M12,2A10,10 0 0,0 2,12C2,16.42 4.87,20.17 8.84,21.5C9.34,21.58
        ...
        <a href="https://twitter.com/ReactStatic" role="button" title="Twitter">
          <svg width="36" height="36" viewBox="0 0 24 24">
            <path
              fill="#55acee" d="M17.71,9.33C18.19,8.93 18.75,8.45 19,7.92C18.59,8.13 18.1,8.26
